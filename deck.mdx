...
<Code
  ...
  steps={[
    { range: [1, 10], notes: 'Interface & Class' },
    { range: [12, 13] },
    { range: [15, 19] },
    { range: [15, 22], notes: 'Extra props are allowed' },
    { range: [1, 22] },
  ]}
/>
...
<Code
  ...
  steps={[
    ...
    { range: [3, 7] },
    { range: [9, 15] },
    { lines: [17], notes: '(a: Person) => boolean' },
  ]}
/>
...
<Code
  ...
  steps={[
    { range: [1, 21] },
    { range: [5, 8], notes: 'Define props' },
    { range: [10, 14], notes: 'Define component' },
    { lines: [18] },
    { range: [20, 21] },
  ]}
/>
...
<Code
  ...
  steps={[
    { lines: [1], notes: 'Various input types 😲' },
...
<Code
  title="Redux"
  code={require("!raw-loader!./demo/redux-3.4.ts")}
  steps={[
    { range: [1, 49] },
    { range: [5, 20], notes: 'Action Creators' },
    { range: [23, 26], notes: 'Actions' },
    { range: [29, 35], notes: 'State' },
    { range: [37, 55], notes: 'Reducer' },
    { range: [42, 45], notes: 'Handle "SendMessageAction"' },
    { range: [46, 51], notes: 'Handle "DeleteMessageAction"' },
  ]}
/>
